  ...
  return (
    <div>
      ...
      <div className="flex px-3 flex-wrap gap-5 sm:px-0 justify-between mt-2 mb-7 items-center">
        <h3 className="text-[#141414] mt-3 font-semibold text-xl">
          Company Bio
        </h3>
      ...
      <div className="text-[#141414] mb-10 px-3 sm:px-0">
        ...
        <p>
          ...
          client-first approach and a proven track record of success, we are
          committed to transforming visions into reality and building lasting
          partnerships that fuel sustainable success.
        </p>
        <br />
        <p>
          Mission: To provide innovative, results-driven solutions that inspire
          growth and empower businesses to reach their full potential.
        </p>
        <p>
          {" "}
      ...
      <div className="mb-10 px-3 sm:px-0">
        ...
        <form
          className="border p-4 sm:px-7 sm:py-7 border-gray-300 rounded-lg grid gap-x-5 sm:grid-cols-2 sm:gap-x-8 gap-y-3 sm:gap-y-5"
        ...
        >
          <div className="">
            ...
            <input
              readOnly
              id="contactName"
              className="block w-full px-5  text-gray-400 py-3 border outline-none rounded"
          ...
          <div className="">
            ...
            <input
              readOnly
              id="email"
              className="block w-full px-5 py-3  text-gray-400 border outline-none rounded"
